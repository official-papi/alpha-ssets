...
-- ==============================================================================
INSERT INTO public.investment_plans (name, badge, description, min_amount, max_amount, roi_percentage, payout_interval_hours, total_payout_periods, capital_back)
VALUES 
('Starter Plan', 'Entry', 'Ideal for beginner investors starting small.', 20.00, 500.00, 2.50, 24, 30, true),
('Ultimate Growth', 'Popular', 'High yield investment for steady daily compounding.', 500.00, 5000.00, 4.20, 24, 45, true),
('VIP Quantum Vault', 'Exclusive', 'Maximum returns for institutional capital.', 5000.00, 50000.00, 7.50, 12, 60, true)
